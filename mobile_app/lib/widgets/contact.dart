          ...
          const Expanded(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 15),
                _ContactItem(icon: Icons.location_on, text: "562 Kithulampitiya Road, Street 31, Galle, Sri Lanka"),
                _ContactItem(icon: Icons.email, text: "sukkanama@gmail.com"),
                _ContactItem(icon: Icons.phone, text: "+94 077 987 8765"),
                _ContactItem(icon: Icons.access_time, text: "We're here for you 24/7"),
              ],
            ),
          ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text(name, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Colors.teal)),
